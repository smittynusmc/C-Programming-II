...
Humanizer::Localisation::NumberToWords::EnglishNumberToWordsConverter::EnglishNumberToWordsConverter(int myNum)
{
	EnglishNumberToWordsConverter::number = myNum;
}

std::string EnglishNumberToWordsConverter::Convert() const
{
	return Convert(EnglishNumberToWordsConverter::number, false);
}
...
void EnglishNumberToWordsConverter::print(int numberToConvert, std::string result) {
	std::cout << "Your English description of " << numberToConvert << " is " + result << std::endl;
}
